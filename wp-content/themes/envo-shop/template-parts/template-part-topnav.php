...
<?php } ?>
<div class="site-header container-fluid" style="background-color: rgba(0,0,0,0.1);">
...
<?php do_action('envo_shop_before_menu'); ?> 
 <!-- <div class="main-menu">
    <nav id="site-navigation" class="navbar navbar-default">     
        <div class="container">   
            <div class="navbar-header">
                <div class="site-heading mobile-heading visible-xs" >
                    <?php 
                    // envo_shop_title_logo('p'); ?>
                </div>
                <?php 
                // if (function_exists('max_mega_menu_is_enabled') && max_mega_menu_is_enabled('main_menu')) : ?>
                <?php 
                    // else : ?>
                    <span class="navbar-brand brand-absolute visible-xs"><?php 
                    // esc_html_e('Menu', 'envo-shop'); ?></span>
                    <?php 
                    // if (function_exists('envo_shop_header_cart') && class_exists('WooCommerce')) { ?>
                        <div class="mobile-cart visible-xs" >
                            <?php 
                            // envo_shop_header_cart(); ?>
                        </div>	
                    <?php 
                    // } ?>
                    <?php 
                    // if (function_exists('envo_shop_my_account') && class_exists('WooCommerce')) { ?>
                        <div class="mobile-account visible-xs" >
                            <?php 
                            // envo_shop_my_account(); ?>
                        </div>
                    <?php 
                    // } ?>
                    <?php 
                    // if (function_exists('envo_shop_head_wishlist') && class_exists('WooCommerce')) { ?>
                        <div class="mobile-wishlist visible-xs" >
                            <?php 
                            // envo_shop_head_wishlist(); ?>
                        </div>
                    <?php 
                    // } ?>
                    <?php
                    //  if (function_exists('envo_shop_head_compare') && class_exists('WooCommerce')) { ?>
                        <div class="mobile-compare visible-xs" >
                            <?php 
                            // envo_shop_head_compare(); ?>
                        </div>
                    <?php 
                    // } ?>
        ...
        <?php 
        // do_action('envo_shop_menu'); ?>
    </nav> 
</div>
<?php
//  do_action('envo_shop_after_menu');
?>  -->
